codeunit 50100 "BDL Seminar-Post"
{
    ...
    begin
        ...
        with SeminarRegHeader do begin
            ...
            SourceCodeSetup.Get;
            SourceCode := SourceCodeSetup."BDL Seminar";
    ...
    var
        ...
        SeminarRegLine: Record "BDL Seminar Registration Line";
        PstdSeminarRegHeader: Record "BDL Posted Seminar Reg. Header";
        PstdSeminarRegLine: Record "BDL Posted Seminar Reg. Line";
        SeminarCommentLine: Record "BDL Seminar Comment Line";
        SeminarCommentLine2: Record "BDL Seminar Comment Line";
        SeminarCharge: Record "BDL Seminar Charge";
        PstdSeminarCharge: Record "BDL Posted Seminar Charge";
        Room: Record Resource;
        Instructor: Record Resource;
        Customer: Record Customer;
        ResLedgEntry: Record "Res. Ledger Entry";
        SeminarJnlLine: Record "BDL Seminar Journal Line";
        SourceCodeSetup: Record "Source Code Setup";
        ResJnlLine: Record "Res. Journal Line";
        SeminarJnlPostLine: Codeunit "BDL Seminar Jnl.-Post Line";
    ...
    begin
        ...
        begin
            Resource.TestField("BDL Quantity Per Day");
            ResJnlLine.Init;
            ...
            ResJnlLine.Quantity := Duration * Resource."BDL Quantity Per Day";
            ResJnlLine."Total Cost" := ResJnlLine."Unit Cost" * ResJnlLine.Quantity;
            ResJnlLine."BDL Seminar No." := "Seminar No.";
            ResJnlLine."BDL Seminar Registration No." := PstdSeminarRegHeader."No.";
