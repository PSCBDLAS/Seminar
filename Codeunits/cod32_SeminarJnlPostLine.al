codeunit 50132 "BDL Seminar Jnl.-Post Line"
// BDL1.00 - 2018-01-01 - D. E. Veloper
// Chapter 7 - Lab 2-2
{
    TableNo = "BDL Seminar Journal Line";
    ...
    var
        ...
        SeminarRegister: Record "BDL Seminar Register";
        SeminarJnlCheckLine: Codeunit "BDL Seminar Jnl.-Check Line";
        NextEntryNo: Integer;

    procedure RunWithCheck(var SeminarJnLine2: Record "BDL Seminar Journal Line");
    var
        myInt: Integer;
    begin
