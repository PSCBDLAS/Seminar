table 50110 "BDL Seminar Reg. Header"
{
    ...
    fields
    {
            ...
            begin
                if "Room Resource No." = '' then begin
                    ...
                    if (CurrFieldNo <> 0) then begin
                        if (SeminarRoom."BDL Maximum Participants" <> 0) and
                           (SeminarRoom."BDL Maximum Participants" < "Maximum Participants")
                        then begin
                            if Confirm(Text004, true,
                                 "Maximum Participants",
                                 SeminarRoom."BDL Maximum Participants",
                                 FieldCaption("Maximum Participants"),
                                 "Maximum Participants",
                                 SeminarRoom."BDL Maximum Participants")
                            then
                                "Maximum Participants" := SeminarRoom."BDL Maximum Participants";
                        end;
                    end;
                end;
            end;
        ...
        {
            Caption = 'Comment';
            CalcFormula = Exist ("BDL Seminar Comment Line" where ("Table Name" = const ("Seminar Registration"),
                                                              "No." = Field ("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
