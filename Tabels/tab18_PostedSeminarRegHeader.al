table 50118  "BDL Posted Seminar Reg. Header"
{
// BDL1.00 - 2018-01-01 - D. E. Veloper
// Chapter 7 - Lab 3-1
    Caption = 'Posted Seminar Reg. Header';
    LookUpPageID= "BDL Posted Seminar Reg. List";
    DrillDownPageID= "BDL Posted Seminar Reg. List";
    ...
    Fields
    {
        ...
        {
            Caption = 'Comment';
            CalcFormula = Exist ("BDL Seminar Comment Line" where ("Table Name" = const("Posted Seminar Registration"),
                                                              "No." = Field ("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
