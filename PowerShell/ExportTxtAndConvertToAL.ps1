...
Export-NAVApplicationObject -DatabaseServer 'localhost' -DatabaseName 'Demo Database NAV (13-0)' -Filter 'Type=Report;Id=206' -Path 'c:\temp\Al\Objects.txt' -Username 'Admin' -Password '1<3VScode' -ExportToNewSyntax
